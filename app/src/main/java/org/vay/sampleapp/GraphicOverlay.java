...
/*
 * This has been copied from the Google MLKit vision-quickstart app.
 * https://github.com/googlesamples/mlkit/blob/master/android/vision-quickstart/
 */
...
public class GraphicOverlay extends View {
	...
	// Matrix for rotating around the origin
	private final Matrix mappingMatrix = new Matrix();
	...
	public abstract static class Graphic {
		...
		/**
		 * Adjusts the x coardinate from the image's coordinate system to the view coordinate system.
		 */
	...
	private void setMappingMatrix(Rect cropRect, int rotationDegrees) {
	}
